...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill drills, scrimmages, and competitive play",
    ...
    "Drama Club": {
        "description": "Acting workshops and student theater productions",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["charlotte@mergington.edu", "harper@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice argumentation and compete in debate events",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["elijah@mergington.edu", "james@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Collaborative science challenges and competitions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
...
def unregister_from_activity(activity_name: str, participant_email: str):
